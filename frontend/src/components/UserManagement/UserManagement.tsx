...
const UserManagement: React.FC = () => {
  ...
  const [filterRole, setFilterRole] = useState<'todos' | 'admin' | 'user'>('todos');
      ...
      <main className="main-content">
        <div className="dashboard-container">
          <header className="content-header">
            ...
            <button className="btn-primary" onClick={handleCriarNovoUsuario} disabled={buttonLoading}>
              {buttonLoading ? (
                <Lottie
                  animationData={loadingAnimation}
                      ...
                      <tr key={usuario.id} className={currentUserId === usuario.id ? 'current-user' : ''}>
                        ...
                        <td className="actions-cell">
                          <button
                            ...
                            title="Editar"
                            disabled={editLoading === usuario.id}
                          >
                            {editLoading === usuario.id ? (
                              <Lottie
                                animationData={loadingAnimation}
